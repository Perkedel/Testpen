...
public sealed class HierarchyPanel : Widget
{
	...
	public Action<IReadOnlyList<ControlRecord>> RecordsDuplicateRequested;
	...
	public Action<ControlRecord> CustomStylesRequested;
	...
	internal void NotifyDuplicateRequested( IReadOnlyList<ControlRecord> records ) => RecordsDuplicateRequested?.Invoke( records );
	...
	internal void NotifyCustomStylesRequested( ControlRecord record ) => CustomStylesRequested?.Invoke( record );
