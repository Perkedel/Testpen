...
namespace WasmBox.Wasm.Interpret {
    ...
    public sealed class DefaultInstructionInterpreter : InstructionInterpreter {
        ...
        static DefaultInstructionInterpreter() {
            ...
            Default.ImplementOperator( Operators.SizeMemory, OperatorImpls.SizeMemory );
            Default.ImplementOperator( Operators.GrowMemory, OperatorImpls.GrowMemory );
            Default.ImplementOperator( Operators.InitMemory, OperatorImpls.InitMemory );
            Default.ImplementOperator( Operators.DropData, OperatorImpls.DropData );
            Default.ImplementOperator( Operators.CopyMemory, OperatorImpls.CopyMemory );
            Default.ImplementOperator( Operators.FillMemory, OperatorImpls.FillMemory );
            ...
            Default.ImplementOperator( Operators.Int32ExtendByteS, OperatorImpls.Int32ExtendByteS );
            Default.ImplementOperator( Operators.Int32ExtendInt16S, OperatorImpls.Int32ExtendInt16S );
            Default.ImplementOperator( Operators.Int64ExtendByteS, OperatorImpls.Int64ExtendByteS );
            Default.ImplementOperator( Operators.Int64ExtendInt16S, OperatorImpls.Int64ExtendInt16S );
            Default.ImplementOperator( Operators.Int64ExtendInt32S, OperatorImpls.Int64ExtendInt32S );
        }
    }
}
