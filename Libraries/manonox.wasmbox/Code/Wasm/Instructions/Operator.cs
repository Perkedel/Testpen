...
namespace WasmBox.Wasm.Instructions {
    ...
    public abstract class Operator {
        ...
        public Operator( byte opCode, uint index, WasmType declaringType, string mnemonic ) {
            OpCode = opCode;
            Index = index;
            DeclaringType = declaringType;
            Mnemonic = mnemonic;
        ...
        /// <summary>
        /// Index for prefixed operators
        /// </summary>
        /// <returns>The prefixed operator's index.</returns>
        public uint? Index { get; private set; } = null;
